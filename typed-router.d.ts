...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'agent-product': RouteRecordInfo<'agent-product', '/agent/product', Record<never, never>, Record<never, never>>,
    'agent-quotation': RouteRecordInfo<'agent-quotation', '/agent/quotation', Record<never, never>, Record<never, never>>,
    ...
    'apps-ecommerce-product-cart': RouteRecordInfo<'apps-ecommerce-product-cart', '/apps/ecommerce/product/cart', Record<never, never>, Record<never, never>>,
